...
This file maps features to code locations and describes responsibilities.

- Frontend: code/frontend — Next.js (App Router)
- Backend: code/backend — FastAPI + inference
- Storage/DB: supabase helpers in code/frontend and supabase/ migration files
- Deployment: code/Dockerfile.frontend, code/Dockerfile.backend, code/docker-compose.yml, nginx/

(Replace with fuller project map as needed.)
**PROJECT MAP**
