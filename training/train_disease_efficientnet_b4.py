...
def get_args():
    parser = argparse.ArgumentParser(description="Train EfficientNet-B4 for disease classification")
    ...
    parser.add_argument("--output", type=str, default="../backend/app/models/disease_efficientnet_b4.pt")
    parser.add_argument(
        "--label-output",
        type=str,
...
def main():
    ...
    print("=" * 80)
    print("[Disease Training] EfficientNet-B4")
