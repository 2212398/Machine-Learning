...
def get_args():
    parser = argparse.ArgumentParser(description="Train MobileNetV3 for plant type classification")
    ...
    parser.add_argument("--output", type=str, default="../backend/app/models/plant_mobilenetv3.pt")
    parser.add_argument(
        "--label-output",
        type=str,
...
def main():
    ...
    print("=" * 80)
    print("[Plant Training] MobileNetV3")
